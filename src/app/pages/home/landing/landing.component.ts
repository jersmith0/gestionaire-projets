    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800">
      <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-10">
          ...
          <a href="#examples" class="text-slate-300 hover:text-violet-400 transition-colors">Exemples</a>
    ...
    <footer class="py-12 px-6 bg-slate-950 border-t border-slate-800">
      <div class="max-w-6xl mx-auto text-center text-slate-500">
        <div class="flex justify-center gap-12 md:gap-16 mb-6">
          <!-- X (Twitter) -->
          <a href="https://x.com/toncompte" target="_blank" rel="noopener noreferrer" class="text-slate-400 hover:text-white transition-all duration-300 hover:scale-110">
          ...
          <!-- GitHub -->
          <a href="https://github.com/tonusername" target="_blank" rel="noopener noreferrer" class="text-slate-400 hover:text-white transition-all duration-300 hover:scale-110">
            <svg class="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
          ...
          <!-- Discord -->
          <a href="https://discord.gg/tonserveur" target="_blank" rel="noopener noreferrer" class="text-slate-400 hover:text-white transition-all duration-300 hover:scale-110">
            <svg class="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
